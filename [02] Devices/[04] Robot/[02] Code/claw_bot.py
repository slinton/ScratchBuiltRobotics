...
# Author: Sam Linton
# Date: 2025-06-06
# Description: Remote control or autonomous robot that has a claw.
#
# Consider: change JoystickController output to -100 to 100
#
...
if __name__ == '__main__':
    robot = ClawRobot(led_pin=6, buzzer_pin=22, claw=Claw())
