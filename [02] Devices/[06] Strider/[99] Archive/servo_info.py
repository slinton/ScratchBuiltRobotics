...
class ServoInfo:
    ...
    def __init__(self,
        ...
        Args:
            pin (int): pin number corresponding to the servo
    ...
    def __str__(self) -> str:
        return f'Servo Info: {self._name} at pin {self._pin} with index {self._index}. Angle: {self._angle} Range: {self._angle_start}-{self._angle_end} 0 angle = {self._servo_angle_0}'
    
   
if __name__ == "__main__":
    # Test code
    servo_info = ServoInfo(pin = 15, index=0, servo_angle_0=90, sign=-1, angle_start=0, angle_end=180, name='Servo 2')
    print(servo_info)
